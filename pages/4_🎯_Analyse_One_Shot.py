...
st.set_page_config(page_title="AMPLITEL ANALYSE", page_icon="🎯", layout="wide")
...
itv = pd.read_csv('./Dataset/V1/itv_cleaned_amp.csv', index_col = 0)
ae_all = pd.read_csv('./Dataset/V1/ae_all_cleaned_amp.csv', index_col = 0)
ae_tech = pd.read_csv('./Dataset/V1/ae_tech_cleaned_amp.csv', index_col = 0)
ae_cr = pd.read_csv('./Dataset/V1/ae_cr_cleaned_amp.csv', index_col = 0)
